    ...
    public void readCSVFile(String csvFileName) throws FileNotFoundException {
        ...
        while (scanner.hasNextLine()) {
            ...
            if (fields.length >= 14) {
                ...
                Participant person1 = new Participant(id, name, age, hasKitchen, foodPreference, sex, kitchen_story, kitchen_location);
                Participant person2 = new Participant(id_2, name_2, age_2, hasKitchen, foodPreference, sex_2, kitchen_story, kitchen_location);
