...
public class CompareParticipantsDialog extends JDialog {
    private JTable resultTable;

    public CompareParticipantsDialog(JFrame parentFrame, Participant participant1, Participant participant2) {
