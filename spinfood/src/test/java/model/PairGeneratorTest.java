...
class PairGeneratorTest {
    ...
    void generateInitialPopulation() throws FileNotFoundException {
        ...
        List<Pair> population = pairGenerator.generateInitialPopulation(participantList,num);
    ...
    void generateInitialPopulationFromDifferentParticipant() throws FileNotFoundException {
        ...
        List<Pair> population = pairGenerator.generateInitialPopulation(participantList,num);// make pair with method
